...
while not user_choice == "e":
	...
	if user_choice == "h":
		...
		if clear_history == "y":
			...
			# TODO: Missing a user option to not clear history and do something else.
			continue

		# TODO: If else has only one keyword like break, return or continue,
		#  that can be left as is. Fixed.
		continue

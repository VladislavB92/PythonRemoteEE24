# TODO: You don't need brackets for the imports if they are on the same line.
...
while continue_calculation == "y":
	...
	if operator == "/":
		while second_number == "0" or number_is_digit(second_number) != "digit":
			# TODO: A better way how to split long print lines. Fixed.
			print(
...
if save_history == "n":
	# TODO: It would be better to move all file operations to 3 separate functions. But that is nitpicking.
